...
def usage():
    print "\033[1;91m#########################################################"
    print "#------------------------[\033[1;91m434-DDOS\033[1;32m]---------------------#"
    print "#-------------------------------------------------------#"
    print "#   \033[1;91mCommand: " "python2 ddos.py " "<ip> <port> <packet> \033[1;32m      #"
    print "#                                                       # "
    print "#\033[1;32mCreator:Squ4r3-B4D                                     #"
    print "#\033[1;32mTeam   :BVC                                            #"
    print "#\033[1;32mMail   :cyberontime1011@gmail.com                      #"
    print "\033[1;91m#               \033[1;91m<--[Black Venom Cyber]-->               #"
    print "#########################################################"
    print "                        @@@@@@@@@@"
    print "                       @@@@@@@@@@@@"
    print "                     @@@@@@@@@@@@@@@@"
